                      ...
                      <Row gutter={[16, 16]}>
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            ...
                            <div className="practice-list-box-item--content">Test 1</div>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 2</div>
                            <div className="practice-list-box-item--participants">
                              <span>15.2K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 3 </div>
                            <div className="practice-list-box-item--participants">
                              <span>11.9K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 4</div>
                            <div className="practice-list-box-item--participants">
                              <span>9.1K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 5 </div>
                            <div className="practice-list-box-item--participants">
                              <span>8.8K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 6</div>
                            <div className="practice-list-box-item--participants">
                              <span>8.4K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 7</div>
                            <div className="practice-list-box-item--participants">
                              <span>5.7K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 8 </div>
                            <div className="practice-list-box-item--participants">
                              <span>4.7K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 9</div>
                            <div className="practice-list-box-item--participants">
                              <span>5.1K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 10 </div>
                            <div className="practice-list-box-item--participants">
                              <span>4.5K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 11 </div>
                            <div className="practice-list-box-item--participants">
                              <span>3.6K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 12 </div>
                            <div className="practice-list-box-item--participants">
                              <span>3.3K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 13 </div>
                            <div className="practice-list-box-item--participants">
                              <span>3K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 14</div>
                            <div className="practice-list-box-item--participants">
                              <span>2.8K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 15 </div>
                            <div className="practice-list-box-item--participants">
                              <span>2.6K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 16 </div>
                            <div className="practice-list-box-item--participants">
                              <span>2.5K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 17 </div>
                            <div className="practice-list-box-item--participants">
                              <span>2.4K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 18 </div>
                            <div className="practice-list-box-item--participants">
                              <span>2.4K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 19 </div>
                            <div className="practice-list-box-item--participants">
                              <span>2.4K</span>
                              <div className="line"></div>
                              <span>Participants</span>
                        ...
                        <Col className="gutter-row" span={6}>
                          <div className="practice-list-box">
                            <div className="practice-list-box-item--progress progress-none">0%</div>
                            <div className="practice-list-box-item--content">Test 20</div>
                            <div className="practice-list-box-item--participants">
                              <span>3.1K</span>
                              <div className="line"></div>
                              <span>Participants</span>
